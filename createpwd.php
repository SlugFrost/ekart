...
<head>
    ...
    <meta charset="utf-8">
    <title>Change Passowrd | Toner eCommerce + Admin HTML Template</title>
                            ...
                            <div class="card border-0 mb-4">
                                ...
                                <div class="card-body">
                                        ...
                                        <form action="auth-signin-basic.html">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    ...
                                                    <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="confirm-password-input"><i class="bi bi-eye-fill align-middle"></i></button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">Wait, I remember my password... <a href="http://localhost/NewToner/?auth=register" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
