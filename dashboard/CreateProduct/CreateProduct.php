        ...
        <div class="main-content">
            <div class="page-content">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $folder = "../dashboard/" . $filename;

                    $sql = $db->query("SELECT * FROM `products` WHERE pname='{$pname}' ");
                    if (mysqli_num_rows($sql) < 1) {

                        $insertquery = $db->query("INSERT INTO `products`(pname, description, category, instock, outofstock, price, orders,filename) VALUES ('{$pname}','{$description}','{$category}','{$instock}', '{$outofstock}', '{$price}', '{$orders}', '{$filename}')");
                ...
                <form method="POST" action="" enctype="multipart/form-data" autocomplete="off" class="needs-validation">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="stocks-input" name="instock" placeholder="Stocks" required="">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="stocks-input" name="outofstock" placeholder="Stocks" required="">
                                                <div class="invalid-feedback">Please enter a product stocks.</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="orders" placeholder="Orders" required="">
