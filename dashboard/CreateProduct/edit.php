                    ...
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                ...
                                <li class="breadcrumb-item"><a href="#" class=" text-decoration-none">Product</a></li>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header p-3 bg-white">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="card-title mb-1 word-1">Product Information</h5>
                                ...
                                <input type="hidden" name="id" value="<?php echo $id; ?>">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="pname" value="<?php echo $pname; ?>" placeholder="Enter product Name" required="">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-medium">Product Description</label>
                                        <input type="text" class="form-control" name="description" value="<?php echo $description; ?>" placeholder="Enter product Description" required="">
                                    </div>
                                    ...
                                    <div>
                                        <div class="d-flex align-items-start">
                                            ...
                                            <input type="text" class="form-control" name="category" value="<?php echo $category; ?>" placeholder="Enter product Category" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header p-3 bg-white">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="card-title mb-1 word-1">Product Gallery</h5>
                                            <p class="text-muted mb-0 word-2">Add product gallery images.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="" >
                                        <input type="file" id="upload" name="filename" value="<?php echo $filename; ?>" hidden>
                                        <label for="upload" class="uploadlabel image-clickable">
                                        <div class="dz-message">
                                            <div class="mb-3">
                                                <i class="display-4 text-secondary bi bi-cloud-upload-fill"></i>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="stocks-input">In-Stock</label>
                                                <input type="text" class="form-control" id="stocks-input" name="instock" value="<?php echo $instock; ?>" placeholder="Stocks" required="">
                                                <div class="invalid-feedback">Please enter a product stocks.</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="stocks-input">Out-Of-Stock</label>
                                                <input type="text" class="form-control" id="stocks-input" name="outofstock" value="<?php echo $outofstock; ?>"placeholder="Stocks" required="">
                                                <div class="invalid-feedback">Please enter a product stocks.</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="orders" value="<?php echo $orders; ?>" placeholder="Orders" required="">
                            ...
                            $enter = $sql->fetch_array();
                                   ...
                                   if(isset($_POST['update'])){
                                    ...
                                    $db->query("UPDATE products SET pname ='{$pname}', description ='{$description}', category ='{$category}',filename ='{$filename}', instock ='{$instock}', outofstock ='{$outofstock}', price ='{$price}', orders ='{$orders}' WHERE id='{$_GET['id']}'");
                            ...
                            <div class="text-end mb-3">
                                <button type="submit" name="update" class="btn btn-success w-sm">Update</button>
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
